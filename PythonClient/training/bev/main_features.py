...
from PythonClient.envs.bev.env_features_v1 import Env
...
if __name__ == "__main__":
    ...
    #
    # env = Env(width=500, height=500, cam_count=3, max_skeletons=2, mode="train")
    # obs, info = env.reset()
    # while True:
    #     start = time.time()
    ...
    #
    #     if env.current_estimation is not None:
    #         plot_utils.open3d_multiple_skeletons(env.current_estimation)
    #         plot_utils.open3d_multiple_skeletons(env.current_skeletons[0])



    models_dir = f"E:/Vag/Programs/UnrealEngine/UE 5.5/DemoSimulationUE5/PythonClient/models/bev/{int(time.time())}"
    logdir = f"E:/Vag/Programs/UnrealEngine/UE 5.5/DemoSimulationUE5/PythonClient/logs/bev/{int(time.time())}"
    ...
    # client.start()
    #
    # base_model_path = "E:/Vag/Programs/UnrealEngine/UE 5.5/DemoSimulationUE5/PythonClient/models/yolo/FeaturesV4_1P_3C_1S_A2C_100000"
    #
    # steps = 0
