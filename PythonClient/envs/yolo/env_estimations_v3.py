...
class Env(gym.Env):
    def __init__(self, width, height, cam_count, max_skeletons, history=5, fake_client=None, mode="train"):
        ...
        self.observation_space = spaces.Box(low=0, high=1, shape=(history, cam_count, max_skeletons, 13), dtype=np.float32)
    ...
    def reset(self, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        self.current_obs = np.zeros((self.history, self.cam_count, self.max_skeletons, 13), dtype=np.float32)
    ...
    def step(self, action):
        ...
        self.current_obs[0] = new_confidences
